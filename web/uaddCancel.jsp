    ...
    <body>
        ...
        <div class="main-container">
            <div class="pd-ltr-20 xs-pd-20-10">
                ...
                <form method="post" action="addcancle.jsp" onsubmit="return matchPassword()" > 
                <table class="table hover nowrap">
                    ...
                    <tbody>
                        <%
                            try {
                               ...
                               if(!rs.next())
                               {
                                   session.setAttribute("msg", "No Bookings are available to cancel.");
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Return Amount</label>
                        <div class="col-sm-12 col-md-10">
