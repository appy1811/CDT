    ...
    <body>
        ...
        <div class="main-container">
            <div class="pd-ltr-20 xs-pd-20-10">
                <hr><h3>Add Flat-Gallery</h3><hr>
                <form method="post" action="uploadGallery" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Description</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" required="" placeholder="Photo Description" id="rpass" name="desc" type="text">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Flat Photo</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" required="" placeholder="Select Photo" id="rpass" name="photo" type="file">
                        </div>
                    </div>
                ...
                <table class="table table-responsive-lg pagination-sm">
                    <thead>
                    <th>ID</th>
                    <th>Description</th>  <th>Photo</th> <th></th> 
                    </thead>
                    <tbody>
                        <%
                            try {
                        ...
                        <tr>
                            ...
                            <td class="cell"><img src="getImage?id=<%=rs.getString("id")%>" height="150" width="150"></td>  
                            <td><a href="udeleteg.jsp?id=<%=rs.getString("id")%>">Delete</a> </td>    </tr>
