    ...
    <body>
        ...
        <div class="main-container">
            <div class="pd-ltr-20 xs-pd-20-10">
                <h2>Add Flat-Booking Details</h2>
                <br>    
                <form method="post" onsubmit="return matchPassword()" action="addbook.jsp">
                    ...
                    <table class="data-table table stripe hover nowrap">
                        ...
                        <tbody>
                            ...
                            <%
                                try {
                                    ResultSet rs = DBCON.getConnection().createStatement().executeQuery("select * from flatdetails where id not in(select fid from flatbooking)");
                                    if(!rs.next())
                                    {
                                        session.setAttribute("msg", "All Flats are already booked.");
                            ...
                            %>
                            <tr>
                                <td><input type="radio" required=""  name="id" value="<%=rs.getString("id")%>" ></td><td> <%=i%></td>
                                <td><%=rs.getString("projectno")%></td>
                                <td><%=rs.getString("buildingno")%></td>
                                <td><%=rs.getString("roomno")%></td>
                                <td><%=rs.getString("area")%></td> 
                                <td><%=rs.getString("amount")%>
                                    <input type="hidden" name="famt" id="famt" value="<%= rs.getString("amount")%>" ></td>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" required="" placeholder="Booking date" id="rpass" name="bdate" type="date">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Booking Amount</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" required="" id="bamt" placeholder="Booking Amount"  name="amt" type="number">
                        </div>
                    </div>
                    <div class="form-group row">
