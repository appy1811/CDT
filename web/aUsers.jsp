            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                ...
                <form  method="post" action="addusers.jsp">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" required="" placeholder="Phone Number" id="rpass" name="phno" type="text">
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-12 col-md-12 col-form-label"><%
                            ...
                            <hr><h3>View users</h3><hr>
                            <table class="table table-responsive-lg pagination-sm">
                                <thead>
                                <th>ID</th>
                                <th>Name</th> <th>Address</th> <th>Email ID</th> <th>Phone Number</th> <th>Username</th>
                               <th></th>  </thead>
                                <tbody>
                                  <%
                                                    try{
                                                    ...
                                                    for(int i=1;rs.next();i++)
                                                    {
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td><%=rs.getString("phno")%></td> <td><%=rs.getString("uname")%></td>
                                                        <td><a href="deleteu.jsp?id=<%=rs.getString("uname")%>">Delete</a> </td>
                                                    </tr>
