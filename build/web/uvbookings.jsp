        ...
        <div class="main-container">
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="form-group row">
                    ...
                    <label class="col-sm-12 col-md-2 col-form-label "> <h6><a class="fa fa-plus " href="uaddBookings.jsp"> Add New</a></h6> </label>
                </div>
                <div class="row">
                ...
                <table class="table hover data-table-export nowrap">
                    ...
                    <th class="datatable-nosort"></th>  </thead>
                    <tbody>
                        <%
                            try {
                        ...
                        <tr>
                            ...
                            <td><a class="fa fa-trash-o" href="udeletebooking.jsp?id=<%= rs.getString("flatbooking.id")%>">Delete</a></td>    </tr>
